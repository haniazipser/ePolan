...
class LessonServiceTest {
    ...
    void testUpdateExercisesForLessonSuccess() {
        ...
        ExerciseRequest exDto = new ExerciseRequest(1, "a");
        ExerciseListRequest request = new ExerciseListRequest(Collections.singletonList(exDto));
        ...
        lessonService.updateExercisesForLesson(request, lessonId);
